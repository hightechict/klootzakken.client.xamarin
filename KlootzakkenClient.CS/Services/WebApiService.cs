...
namespace KlootzakkenClient
{
    public static class WebApiGetService
    {
        ...
        private const string _accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..zmwa-iT-28xhbIrOPSDf0oi6zVdhNq7DslDIZRT0lHU";

        public static async Task<List<T>> GetFromWebApi<T>(string urlEnding)
        {
        ...
        public static async Task<T> GetStateFromWebApi<T>(string urlEnding, string id)
        {
            T state;
